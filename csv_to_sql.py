...
# ==============================
# LOAD CSV (NO RANDOM / 1:1 DATA)
# ==============================
df = pd.read_csv(csv_path)

# ==============================
# ENSURE COLUMN ORDER (AS PROVIDED)
# ==============================
expected_columns = [
    "Timestamp","TX_ROOM_TEMPERATURE","TX_ROOM_HUMIDITY","MULTIPLEXER_I_CN","MULTIPLEXER_I_Eb-No",
...
# Clean column names (replace space & dash)
df.columns = [c.strip().replace(" ", "_").replace("-", "_") for c in df.columns]
expected_columns = [c.replace("-", "_") for c in expected_columns]
...
# ==============================
# From: 2026-01-07T10:15
# To  : 2026-01-07 10:15:00
...
# ==============================
# GENERATE INSERT STATEMENTS (1:1 RECORD MATCH)
# ==============================
insert_statements = ""
